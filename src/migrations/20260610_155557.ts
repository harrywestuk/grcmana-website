...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "menu_items_column_meta" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE INDEX "menu_items_column_meta_order_idx" ON "menu_items_column_meta" USING btree ("_order");
  CREATE INDEX "menu_items_column_meta_parent_id_idx" ON "menu_items_column_meta" USING btree ("_parent_id");
  ...
  CREATE INDEX "menu_items_rels_pages_id_idx" ON "menu_items_rels" USING btree ("pages_id");
  CREATE INDEX "menu_items_rels_posts_id_idx" ON "menu_items_rels" USING btree ("posts_id");
  ...
  CREATE INDEX "header_rels_menu_items_id_idx" ON "header_rels" USING btree ("menu_items_id");
